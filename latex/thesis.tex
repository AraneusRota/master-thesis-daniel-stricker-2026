...
Klor is a \chorlang{} implemented in Clojure. Clojure is part of a bigger family of programming languages called Lisps. One could call Lisps the antithesis to pure functional programming languages with dependent types like Lean.
