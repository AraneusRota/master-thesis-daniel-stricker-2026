...
impl Choreography for TicTacToeChoreography {
    ...
    fn run(self, op: &impl ChoreoOp<Self::L>) -> () {
        ...
        let winner = op.locally(PlayerO, |un| {
            ...
            let winner = if hand_input.trim() == hand_x_shared.trim() {Winner::Draw} else {
                if hand_input.trim() == "rock" && hand_x_shared.trim() == "paper" {
                    Winner::X
                } else if hand_input.trim() == "rock" && hand_x_shared.trim() == "scissors" {
                    Winner::O
                } else if hand_input.trim() == "paper" && hand_x_shared.trim() == "rock" {
                    Winner::O
                } else if hand_input.trim() == "paper" && hand_x_shared.trim() == "scissors" {
                    Winner::X
                } else if hand_input.trim() == "scissors" && hand_x_shared.trim() == "rock" {
                    Winner::X
                } else if hand_input.trim() == "scissors" && hand_x_shared.trim() == "paper" {
                    Winner::O
                } else {
                    Winner::Fail
                }
